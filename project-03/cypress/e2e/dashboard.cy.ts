describe("Testa a página de Dashboard", () => {
  it("Deve carregar uma lista com tres pokemons", () => {
    cy.visit("/dashboard");
  ...
  it("Quando clicar em um pokemon deve abrir a página de detalhes e ao clicar em voltar deve voltar para a listagem de 3 pokemons", () => {
    cy.visit("/dashboard");
  ...
  it("Container deve ter um display grid", () => {
    cy.visit("/dashboard");
